...
/** All 151 Generation I Pokémon with types. */
...
/** Sprite URL for a Pokémon by ID (official Gen-1 style artwork). */
export const getSpriteUrl = (id: number): string =>
  `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${id}.png`;

/** Smaller game sprite (96×96, loads faster) – fallback if artwork fails. */
export const getSmallSpriteUrl = (id: number): string =>
  `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${id}.png`;

/** Pick N unique random Pokémon from the full list. */
export function pickRandom(n: number, exclude: number[] = []): Pokemon[] {
  const pool = GEN1_POKEMON.filter((p) => !exclude.includes(p.id));
